...
void step(CPU *cpu) {
  ...
  get_16(&cpu->memory[cpu->sp])); print_registers(&cpu->registers);
  ...
  */
  ...
  case 0x82: {
    // ADD A, D
    add_8(cpu, &cpu->registers.registers.a, cpu->registers.registers.d);
    size = 1;
    break;
  }
  ...
  case 0x94: {
    // SUB A, H
    sub_8(cpu, &cpu->registers.registers.a, cpu->registers.registers.h);
    size = 1;
    break;
  }
